...
func (m *Model) initBindings() {
	...
	m.panelBindings = map[string][]ui.Binding{
		...
		PanelIDHierarchy: {
			{Keys: []string{"enter"}, Display: "<enter>", Desc: "Controls/Activate", Action: ui.ActionSelect, Priority: 100},
			{Keys: []string{" "}, Display: "<space>", Desc: "Toggle on/off", Action: ui.ActionToggle, Priority: 95},
			{Keys: []string{"e"}, Display: "e", Desc: "Edit", Action: ui.ActionEditDevice, Priority: 93},
			{Keys: []string{"r"}, Display: "r", Desc: "Rename", Action: ui.ActionRename, Priority: 92},
			{Keys: []string{"n"}, Display: "n", Desc: "New room", Action: ui.ActionCreateRoom, Priority: 88},
			{Keys: []string{"N"}, Display: "N", Desc: "New zone", Action: ui.ActionCreateZone, Priority: 87},
			{Keys: []string{"d", "delete"}, Display: "d", Desc: "Delete", Action: ui.ActionDelete, Priority: 85},
