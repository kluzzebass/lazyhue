...
type SliderComponent struct {
	*BaseField
	...
	RenderBar   func(value, min, max, width int, styles *ui2.Styles) string
...
func NewSliderComponent(id, label string, value, min, max, step int, styles *ui2.Styles, zones *zone.Manager) *SliderComponent {
