...
func (e *RoomEvent) Render(styles *ui2.Styles, width int) string {
...
func (e *ZoneEvent) Render(styles *ui2.Styles, width int) string {
...
func (e *BridgeHomeEvent) Render(styles *ui2.Styles, width int) string {
