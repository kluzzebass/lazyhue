...
A terminal user interface (TUI) for managing Philips Hue bridges and lights. Built with Go and the [Charm](https://charm.sh) ecosystem, LazyHue follows the lazygit/lazydocker philosophy of keyboard-driven navigation with mouse support.
...
Pre-built binaries are available for Linux, macOS, and Windows on the [Releases](https://github.com/kluzzebass/lazyhue/releases) page.
